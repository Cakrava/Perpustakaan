...
<?php
include 'koneksi.php';
$result = mysql_query("SELECT nokeluar,tglkeluar,peminjam  FROM bukukembali  ORDER BY nokeluar ASC;");
?>
<div class="col-xs-12">
<div class="box">
<div class="box-header">
<h3 class="box-title">List Pengembalian Buku</h3>
</div>
<!--/.box-header -->
<div class="box-body">
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-11">
                        <form role="form" method="POST" action="data/cetakkembali.php" name="penjualan" id="finput">
                            <div class="box-body">
