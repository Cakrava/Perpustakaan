...
<option value="Almanak">Almanak</option>
 ...
 <div class="col-sm-15">
 <input type="text" name="jumlah" value="<?php echo $data['jumlah']?>" class="form-control" readonly >
 </div>
 </div> 
...
<a href="home.php?p=cetakbuku" class="btn btn-primary"><i 
 class="btn btn-primary">Cetak Data</i></a> 
...
<option value="Almanak">Almanak</option>
  ...
  <label class="col-sm-10 control-label">Status</label>
                            <div class="col-sm-15">
                                <input type="text" name="jumlah" id="jumlah" class="form-control"   value="<?php echo $jumlah ?>" readonly>
                            </div>
                        </div>  
