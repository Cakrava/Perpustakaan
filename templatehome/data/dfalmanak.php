...
<div class="box">
 ...
 <h3 class="box-title">List Buku Almanak</h3>
 </div>
 <!-- /.box-header -->
 <div class="box-body">
 ...
 <?php
 include 'koneksi.php';
 $sql_view = mysql_query("SELECT * FROM buku where kategori ='almanak'ORDER BY judul ASC");
 $total = mysql_num_rows($sql_view);
 ?>
 <br /><br />
 <table id="dfkamus" name="dfkamus" class="table table-bordered table-hover">
 <thead>
<tr>
 <th>No</th>
 <th>Kode Buku</th>
